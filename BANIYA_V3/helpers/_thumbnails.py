...
from BANIYA_V3 import config
from BANIYA_V3.helpers import Track
...
class Thumbnail:
    def __init__(self):
        ...
        self.font1 = ImageFont.truetype("BANIYA_V3/helpers/Raleway-Bold.ttf", 30)
        self.font2 = ImageFont.truetype("BANIYA_V3/helpers/Inter-Light.ttf", 30)
            ...
            async with session.get(url) as resp:
                ...
                def _write_thumb():
                    with open(output_path, "wb") as fw:
                        fw.write(data)
                await asyncio.to_thread(_write_thumb)
            return output_path
