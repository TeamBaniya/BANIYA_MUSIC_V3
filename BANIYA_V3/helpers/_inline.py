...
class Inline:
    ...
    def controls(
        ...
        if status:
            keyboard.append(
                [self.ikb(text=status, callback_data=f"controls status {chat_id}", style=enums.ButtonStyle.SECONDARY)]
            )
        elif timer:
            keyboard.append(
                [self.ikb(text=timer, callback_data=f"controls status {chat_id}", style=enums.ButtonStyle.SECONDARY)]
            )
        ...
        if not remove:
            keyboard.append(
                [
                    ...
                    self.ikb(text="⥁", callback_data=f"controls replay {chat_id}", style=enums.ButtonStyle.SECONDARY),
                    self.ikb(text="‣‣I", callback_data=f"controls skip {chat_id}", style=enums.ButtonStyle.SECONDARY),
    ...
    def help_markup(
        ...
        if back:
            ...
            buttons = [
                self.ikb(text=_lang[f"help_{i}"], callback_data=f"help {cb}", style=enums.ButtonStyle.SECONDARY)
    ...
    def lang_markup(self, _lang: str) -> types.InlineKeyboardMarkup:
        ...
        buttons = [
            self.ikb(
                ...
                style=enums.ButtonStyle.PRIMARY if code == _lang else enums.ButtonStyle.SECONDARY,
            )
    ...
    def yt_key(self, link: str) -> types.InlineKeyboardMarkup:
        return self.ikm(
            [
                [
                    self.ikb(text="❐", copy_text=link, style=enums.ButtonStyle.SECONDARY),
